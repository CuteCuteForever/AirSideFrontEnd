...
export class TransponderStatusService {
  ...
  insertRepairTransponderStatus(jsonTranspondersArray : any){
    return this.http.post<any>(REST_API_SERVER+'insertRepairTransponder', jsonTranspondersArray, {headers: headers}) ;
  }
